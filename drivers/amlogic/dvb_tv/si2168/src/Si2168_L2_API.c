...
#include "../include/Si2168_L2_API.h"               /* Include file for this code */


#ifdef    Si2167B_1A_COMPATIBLE
 #include "../include/Si2167B_ROM0_Firmware_2_0b9.h"       /* firmware compatible with Si2167B_1A */
 ...
 #include "../include/Si2167B_ROM0_Patch_2_0b9.h"          /* firmware compatible with Si2167B_20 */
 #ifndef   Si2167B_LoadFirmware
  #define  Si2167B_LoadFirmware       Si2168_LoadFirmware
  #define  NO_Si2167B_ERROR           NO_Si2168_ERROR
  #define  Si2167B_L1_API_ERROR_TEXT  Si2168_L1_API_ERROR_TEXT
 ...
 #include "../include/Si2168_0B_ROM1_Firmware_0_Cb20.h"    /* firmware compatible with Si2168-0B ROM 1 */
#endif /* Si2168_0B_COMPATIBLE */
#ifdef    Si2168_10_COMPATIBLE
 #include "../include/Si2168_10_ROM1_Patch_0_Cb20.h"       /* patch    compatible with Si2168-10 ROM 1 */
...
#include "../include/Si2168_20_ROM2_Patch_2_0b37.h" 
...
//#include "Si2168_20_ROM2_Patch_2_0b28.h"  
//#include "Si2168_20_ROM2_Patch_2_0b30.h" 
#include "../include/Si2168_30_ROM3_Patch_3_0b11.h" 
...
#ifdef    Si2168_40_COMPATIBLE
#include "../include/Si2168B_ROM1_Patch16_4_0b18.h"          /* patch    compatible with Si2168-40 ROM 1 */
#endif /* Si2168_40_COMPATIBLE */
...
int Si2168_PowerUpWithPatch    (L1_Si2168_Context *api)
{
    ...
    if (!fw_loaded) {
      ...
      if ((api->rsp->part_info.romid  == Si2168_PATCH_0_Cb20_ROM   )
        &((api->rsp->part_info.part   == 68) || (api->rsp->part_info.part   == 69)  )
    ...
    #ifdef    Si2168_PATCH_2_0b37_LINES
    if (!fw_loaded) {
      printk  ("Is this part a  'Si21%2d_ROM%x_%c_%c_b%d'?20b37\n", Si2168_PATCH_2_0b37_PART, Si2168_PATCH_2_0b37_ROM, Si2168_PATCH_2_0b37_PMAJOR, Si2168_PATCH_2_0b37_PMINOR, Si2168_PATCH_2_0b37_PBUILD );
      if ((api->rsp->part_info.romid  == Si2168_PATCH_2_0b37_ROM   )
        &((api->rsp->part_info.part   == 69 ) || (api->rsp->part_info.part == 68 ))
        & (api->rsp->part_info.pmajor == Si2168_PATCH_2_0b37_PMAJOR)
        & (api->rsp->part_info.pminor == Si2168_PATCH_2_0b37_PMINOR)
        & (api->rsp->part_info.pbuild == Si2168_PATCH_2_0b37_PBUILD)) {
          printk("Updating FW for 'Si21%2d_ROM%x %c_%c_b%d'\n", api->rsp->part_info.part, api->rsp->part_info.romid, api->rsp->part_info.pmajor, api->rsp->part_info.pminor, api->rsp->part_info.pbuild );
          #ifdef    Si2168_PATCH_2_0b37_INFOS
          SiTRACE(Si2168_PATCH_2_0b37_INFOS);
          SiERROR(Si2168_PATCH_2_0b37_INFOS);
          #endif /* Si2168_PATCH_2_0b37_INFOS */
          if ((return_code = Si2168_LoadFirmware(api, Si2168_PATCH_2_0b37, Si2168_PATCH_2_0b37_LINES)) != NO_Si2168_ERROR) {
            SiTRACE ("Si2168_LoadFirmware error 0x%02x: %s\n", return_code, Si2168_L1_API_ERROR_TEXT(return_code) );
            return return_code;
          }
          fw_loaded++;
   ...
   #endif /* Si2168_PATCH_2_0b37_LINES */
#endif /* Si2168_20_COMPATIBLE */
...
#ifdef    Si2168_40_COMPATIBLE
	#ifdef    Si2168B_PATCH16_4_0b18_LINES
    if (!fw_loaded) {
      SiTRACE  ("Si2168B_PATCH16_4_0b18: Is this part a  'Si21%2d_ROM%x_%c_%c_b%d'?\n", Si2168B_PATCH16_4_0b18_PART, Si2168B_PATCH16_4_0b18_ROM, Si2168B_PATCH16_4_0b18_PMAJOR, Si2168B_PATCH16_4_0b18_PMINOR, Si2168B_PATCH16_4_0b18_PBUILD );
      if ((api->rsp->part_info.romid  == Si2168B_PATCH16_4_0b18_ROM   )
        &(  (api->rsp->part_info.part == 69 )
         || (api->rsp->part_info.part == 68 )
        )
        & (api->rsp->part_info.pmajor == Si2168B_PATCH16_4_0b18_PMAJOR)
        & (api->rsp->part_info.pminor == Si2168B_PATCH16_4_0b18_PMINOR)
        & (api->rsp->part_info.pbuild == Si2168B_PATCH16_4_0b18_PBUILD)
          ) {
        SiTRACE("Updating FW for 'Si21%2d NVM%c_%cb%d'\n", api->rsp->part_info.part, api->rsp->part_info.pmajor, api->rsp->part_info.pminor, api->rsp->part_info.pbuild );
        #ifdef    Si2168B_PATCH16_4_0b18_INFOS
          SiTRACE(Si2168B_PATCH16_4_0b18_INFOS);
          SiERROR(Si2168B_PATCH16_4_0b18_INFOS);
        #endif /* Si2168B_PATCH16_4_0b18_INFOS */
        if ((return_code = Si2168_LoadFirmware_16(api, Si2168B_PATCH16_4_0b18, Si2168B_PATCH16_4_0b18_LINES)) != NO_Si2168_ERROR) {
          SiTRACE ("Si2168_LoadFirmware_16 error 0x%02x: %s\n", return_code, Si2168_L1_API_ERROR_TEXT(return_code) );
          return return_code;
        }
        fw_loaded++;
      }
    }
	#endif /* Si2168B_PATCH16_4_0b18_LINES */
#endif /* Si2168_40_COMPATIBLE */
...
//  Si2168_L2_Tuner_I2C_Enable(front_end);
  ...
  sprintf(sequence,"%s| (%5ld ms) ",    sequence, system_time()-switch_start);
  SiTRACE("%s\n", sequence);
#endif /* PROFILING */
...
int   Si2168_L2_lock_to_carrier   (Si2168_L2_Context *front_end, int standard, int freq, int dvb_t_bandwidth_hz, int dvb_t_stream, unsigned int symbol_rate_bps, int dvb_c_constellation, int dvb_t2_plp_id)
{
  ...
  if (front_end->lockAbort) {
    SiTRACE("Si2168_L2_lock_to_carrier : lock aborted before tuning, after %ld ms.\n", system_time() - lockStartTime );
    return 0;
  }
  ...
  SiTRACE ("Si2168_lock_to_carrier 'tune'  took %ld ms\n"        , system_time() - searchStartTime);


  Si2168_L1_DD_RESTART            (front_end->demod);
  SiTRACE ("Si2168_lock_to_carrier 'reset' took %ld ms\n"        , system_time() - searchStartTime);
  ...
  while (system_time()-abort_wait_start_ms < min_lock_time_ms) {
    if (front_end->lockAbort) {
      SiTRACE("Si2168_L2_lock_to_carrier : lock aborted before checking lock status, after %ld ms.\n", system_time() - lockStartTime );
      return 0;
    }
  ...
  while (1) {
    ...
    if (front_end->lockAbort) {
      SiTRACE("Si2168_L2_lock_to_carrier : lock aborted after %ld ms.\n", system_time() - lockStartTime);
      return 0;
    }
      ...
      if ( (front_end->demod->status->scanint == Si2168_STATUS_SCANINT_TRIGGERED) ) {
        ...
        switch (front_end->demod->rsp->scan_status.scan_status) {
          case  Si2168_SCAN_STATUS_RESPONSE_SCAN_STATUS_TUNE_REQUEST          : {
            SiTRACE ("blindscan_interaction -- (tune  ) SCAN TUNE_REQUEST at %ld kHz\n", front_end->demod->rsp->scan_status.rf_freq);
            if (front_end->tuneUnitHz == 1) {
...
//            SiTRACE ("blindscan_interaction -- (locked) SCAN DIGITAL lock at %7.3f MHz after %3d ms. modulation %3d (%s)\n", *freq/1000.0, searchDelay, *standard, Si2168_standardName(*standard) );
          ...
          case  Si2168_SCAN_STATUS_RESPONSE_SCAN_STATUS_ERROR                 : {
            SiTRACE ("blindscan_interaction -- (error2) SCAN error at %d after %d ms\n", seek_freq, searchDelay);
...
/**/
int Si2168_LoadFirmware_16(L1_Si2168_Context *api, firmware_struct fw_table[], int nbLines)
{
    int return_code;
    int line;
    int load_start_ms;
    ...
    SiTRACE ("Si2168_LoadFirmware_16 starting...\n");
    SiTRACE ("Si2168_LoadFirmware_16 nbLines %d\n", nbLines);
    load_start_ms = system_time();
    /* for each line in fw_table */
    for (line = 0; line < nbLines; line++) {
      if (fw_table[line].firmware_len > 0)  /* don't download if length is 0 , e.g. dummy firmware */
      {
        /* send firmware_len bytes (up to 16) to Si2168 */
        if ((return_code = Si2168_L1_API_Patch(api, fw_table[line].firmware_len, fw_table[line].firmware_table)) != NO_Si2168_ERROR)
        {
          SiTRACE("Si2168_LoadFirmware_16 error 0x%02x patching line %d: %s\n", return_code, line, Si2168_L1_API_ERROR_TEXT(return_code) );
          if (line == 0) {
          SiTRACE("The firmware is incompatible with the part!\n");
          }
          return ERROR_Si2168_LOADING_FIRMWARE;
    ...
    SiTraceConfiguration("traces resume");
    SiTRACE ("Si2168_LoadFirmware_16 took %ld ms\n", system_time() - load_start_ms);
    SiTRACE ("Si2168_LoadFirmware_16 complete...\n");
    return NO_Si2168_ERROR;
}
