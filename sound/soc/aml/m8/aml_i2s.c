...
unsigned int   trigger_enable_threshold = 500;//static int   trigger_enable_threshold = 100; audio_type_info = -1;
unsigned int   trigger_enable_span	   = 300 * 90;
struct aml_runtime_data *g_prtd = NULL;
...
#define MAX_APTS_SCR_DELTA 500 //ms
...
#define MAX_DELAY_ENABLE 500  //ms 
...
module_param(trigger_enable_threshold, uint, 0664);
MODULE_PARM_DESC(trigger_enable_threshold, "\n sound trigger threshold \n");

module_param(trigger_enable_span, uint, 0664);
MODULE_PARM_DESC(trigger_enable_span, "\n sound trigger span \n");
